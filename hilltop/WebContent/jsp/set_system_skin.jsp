	 	...
	 	<tr>
	   	...
	   	<td align='left' width='60px'>
			   <select name="globalskin">
			   	...
			   	<option value="hilltop" <%="hilltop".equals(globalskin)?"selected":""%>>hilltop</option>
			   </select>
			</td>
			<td align='left' width='60px'>
				<input type="submit" value="设置"/>
			</td>
	   	<td align='left'>[<font color='red' size="2">说明：</font><font size="2" color='blue'>设置完成后会影响所有页面</font>]
	   	</td>
	   </tr>
   </table>
 </form>
